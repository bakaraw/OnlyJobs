...
class _ChatPageState extends State<ChatPage> {
  ...
  Widget build(BuildContext context) {
    ...
    String receiverUserId =
        widget.user['uid'] ?? ''; // Ensure this is the receiver's UID
    ...
    return Scaffold(
                        ...
                        try {
                          ...
                          await firebaseFirestore
                            ...
                            'contacts': FieldValue.arrayUnion(
                                [receiverUserId]), // Add to sender's contacts
                          }, SetOptions(merge: true));

                          // Check the receiver's contact list
                          DocumentSnapshot receiverDoc = await firebaseFirestore
                              .collection('User')
                              .doc(receiverUserId)
                              .get();
                          List<dynamic> receiverContacts =
                              receiverDoc['contacts'] ?? [];
                            ...
                            if (!pendingList.contains(currentUserId)) {
                              await firebaseFirestore
                                ...
                                'pending': FieldValue.arrayUnion([
                                  currentUserId
                                ]), // Add sender to receiver's pending
                              }, SetOptions(merge: true));
                            }
                          }
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Row(
          mainAxisAlignment:
              MainAxisAlignment.spaceEvenly, // This spaces the icons
          children: [
            IconButton(
              onPressed: () {
                Navigator.push(
